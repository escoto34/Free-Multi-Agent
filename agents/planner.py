...
SYSTEM_PROMPT = (
    ...
    "snippet) plus a CHAT HISTORY block (recent conversation). Treat PROJECT CONTEXT\n"
    "as authoritative for local code facts; treat CHAT HISTORY as the user's intent —\n"
    "align the plan with what was just discussed. Do not invent paths.\n"
    "\n"
